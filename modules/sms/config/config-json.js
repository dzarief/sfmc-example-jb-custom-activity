  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://${req.headers.host}/modules/sms/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `https://${req.headers.host}/modules/sms/publish`
      },
      validate: {
        url: `https://${req.headers.host}/modules/sms/validate`
      },
      stop: {
        url: `https://${req.headers.host}/modules/sms/stop`
      }
    },
    userInterfaces: {
